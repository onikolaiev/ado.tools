...
Remove-Module ado.tools -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\ado.tools\ado.tools.psd1"
Import-Module "$PSScriptRoot\..\ado.tools\ado.tools.psm1" -Force
