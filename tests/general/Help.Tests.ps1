...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\ado.tools\functions", "$global:testroot\..\ado.tools\internal\functions"),
	
	[string]
	$ModuleName = "ado.tools",
...
$CommandPath = @(
    "$global:testroot\..\ado.tools\functions"
    "$global:testroot\..\ado.tools\internal\functions"
)
