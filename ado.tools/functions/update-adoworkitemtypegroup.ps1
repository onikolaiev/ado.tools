...
function Update-ADOWorkItemTypeGroup {
    ...
    process {
        try {
            ...
            Write-PSFMessage -Level Host -Message "Successfully updated group '$GroupId' in section '$SectionId' on page '$PageId' for work item type '$WitRefName' in ProcessId: $ProcessId"
