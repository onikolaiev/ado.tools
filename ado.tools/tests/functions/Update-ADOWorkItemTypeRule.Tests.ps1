Describe "Update-ADOWorkItemTypeRule Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Update-ADOWorkItemTypeRule).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Update-ADOWorkItemTypeRule).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Update-ADOWorkItemTypeRule).Parameters['Token']
		...
		It 'Should have the expected parameter ProcessId' {
			$parameter = (Get-Command Update-ADOWorkItemTypeRule).Parameters['ProcessId']
		...
		It 'Should have the expected parameter WitRefName' {
			$parameter = (Get-Command Update-ADOWorkItemTypeRule).Parameters['WitRefName']
		...
		It 'Should have the expected parameter RuleId' {
			$parameter = (Get-Command Update-ADOWorkItemTypeRule).Parameters['RuleId']
		...
		It 'Should have the expected parameter Body' {
			$parameter = (Get-Command Update-ADOWorkItemTypeRule).Parameters['Body']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Update-ADOWorkItemTypeRule).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Update-ADOWorkItemTypeRule).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Token -ProcessId -WitRefName -RuleId -Body
		__AllParameterSets -Organization -Token -ProcessId -WitRefName -RuleId -Body -ApiVersion -ProgressAction
		#>
	}
