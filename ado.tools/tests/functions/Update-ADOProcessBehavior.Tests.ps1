Describe "Update-ADOProcessBehavior Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Update-ADOProcessBehavior).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Update-ADOProcessBehavior).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Update-ADOProcessBehavior).Parameters['Token']
		...
		It 'Should have the expected parameter ProcessId' {
			$parameter = (Get-Command Update-ADOProcessBehavior).Parameters['ProcessId']
		...
		It 'Should have the expected parameter BehaviorRefName' {
			$parameter = (Get-Command Update-ADOProcessBehavior).Parameters['BehaviorRefName']
			$parameter.Name | Should -Be 'BehaviorRefName'
			$parameter.ParameterType.ToString() | Should -Be System.String
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter Body' {
			$parameter = (Get-Command Update-ADOProcessBehavior).Parameters['Body']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Update-ADOProcessBehavior).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Update-ADOProcessBehavior).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Token -ProcessId -BehaviorRefName -Body
		__AllParameterSets -Organization -Token -ProcessId -BehaviorRefName -Body -ApiVersion -ProgressAction
		#>
	}
