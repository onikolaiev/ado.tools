Describe "Invoke-ADOWorkItemDataMigration Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Invoke-ADOWorkItemDataMigration).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter SourceOrganization' {
			$parameter = (Get-Command Invoke-ADOWorkItemDataMigration).Parameters['SourceOrganization']
		...
		It 'Should have the expected parameter TargetOrganization' {
			$parameter = (Get-Command Invoke-ADOWorkItemDataMigration).Parameters['TargetOrganization']
		...
		It 'Should have the expected parameter SourceToken' {
			$parameter = (Get-Command Invoke-ADOWorkItemDataMigration).Parameters['SourceToken']
		...
		It 'Should have the expected parameter TargetToken' {
			$parameter = (Get-Command Invoke-ADOWorkItemDataMigration).Parameters['TargetToken']
		...
		It 'Should have the expected parameter SourceProjectName' {
			$parameter = (Get-Command Invoke-ADOWorkItemDataMigration).Parameters['SourceProjectName']
		...
		It 'Should have the expected parameter TargetProjectName' {
			$parameter = (Get-Command Invoke-ADOWorkItemDataMigration).Parameters['TargetProjectName']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Invoke-ADOWorkItemDataMigration).Parameters['ApiVersion']
