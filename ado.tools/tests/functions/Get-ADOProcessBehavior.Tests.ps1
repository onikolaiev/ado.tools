Describe "Get-ADOProcessBehavior Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-ADOProcessBehavior).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Get-ADOProcessBehavior).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Get-ADOProcessBehavior).Parameters['Token']
		...
		It 'Should have the expected parameter ProcessId' {
			$parameter = (Get-Command Get-ADOProcessBehavior).Parameters['ProcessId']
		...
		It 'Should have the expected parameter BehaviorRefName' {
			$parameter = (Get-Command Get-ADOProcessBehavior).Parameters['BehaviorRefName']
		...
		It 'Should have the expected parameter Expand' {
			$parameter = (Get-Command Get-ADOProcessBehavior).Parameters['Expand']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Get-ADOProcessBehavior).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-ADOProcessBehavior).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Token -ProcessId -BehaviorRefName
		__AllParameterSets -Organization -Token -ProcessId -BehaviorRefName -Expand -ApiVersion -ProgressAction
		#>
	}
