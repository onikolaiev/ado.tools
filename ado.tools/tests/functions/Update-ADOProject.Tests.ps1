Describe "Update-ADOProject Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Update-ADOProject).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Update-ADOProject).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Update-ADOProject).Parameters['Token']
		...
		It 'Should have the expected parameter ProjectId' {
			$parameter = (Get-Command Update-ADOProject).Parameters['ProjectId']
		...
		It 'Should have the expected parameter Body' {
			$parameter = (Get-Command Update-ADOProject).Parameters['Body']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Update-ADOProject).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Update-ADOProject).Parameters['ProgressAction']
