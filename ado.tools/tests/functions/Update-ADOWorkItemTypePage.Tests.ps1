Describe "Update-ADOWorkItemTypePage Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Update-ADOWorkItemTypePage).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Update-ADOWorkItemTypePage).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Update-ADOWorkItemTypePage).Parameters['Token']
		...
		It 'Should have the expected parameter ProcessId' {
			$parameter = (Get-Command Update-ADOWorkItemTypePage).Parameters['ProcessId']
		...
		It 'Should have the expected parameter WitRefName' {
			$parameter = (Get-Command Update-ADOWorkItemTypePage).Parameters['WitRefName']
		...
		It 'Should have the expected parameter Body' {
			$parameter = (Get-Command Update-ADOWorkItemTypePage).Parameters['Body']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Update-ADOWorkItemTypePage).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Update-ADOWorkItemTypePage).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Token -ProcessId -WitRefName -Body
		__AllParameterSets -Organization -Token -ProcessId -WitRefName -Body -ApiVersion -ProgressAction
		#>
	}
