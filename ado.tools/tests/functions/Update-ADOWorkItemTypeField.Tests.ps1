Describe "Update-ADOWorkItemTypeField Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Update-ADOWorkItemTypeField).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Update-ADOWorkItemTypeField).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Update-ADOWorkItemTypeField).Parameters['Token']
		...
		It 'Should have the expected parameter ProcessId' {
			$parameter = (Get-Command Update-ADOWorkItemTypeField).Parameters['ProcessId']
		...
		It 'Should have the expected parameter WitRefName' {
			$parameter = (Get-Command Update-ADOWorkItemTypeField).Parameters['WitRefName']
		...
		It 'Should have the expected parameter FieldRefName' {
			$parameter = (Get-Command Update-ADOWorkItemTypeField).Parameters['FieldRefName']
			$parameter.Name | Should -Be 'FieldRefName'
			$parameter.ParameterType.ToString() | Should -Be System.String
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter Body' {
			$parameter = (Get-Command Update-ADOWorkItemTypeField).Parameters['Body']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Update-ADOWorkItemTypeField).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Update-ADOWorkItemTypeField).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Token -ProcessId -WitRefName -FieldRefName -Body
		__AllParameterSets -Organization -Token -ProcessId -WitRefName -FieldRefName -Body -ApiVersion -ProgressAction
		#>
	}
