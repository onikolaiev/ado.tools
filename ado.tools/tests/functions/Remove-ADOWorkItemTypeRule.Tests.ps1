Describe "Remove-ADOWorkItemTypeRule Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Remove-ADOWorkItemTypeRule).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Remove-ADOWorkItemTypeRule).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Remove-ADOWorkItemTypeRule).Parameters['Token']
		...
		It 'Should have the expected parameter ProcessId' {
			$parameter = (Get-Command Remove-ADOWorkItemTypeRule).Parameters['ProcessId']
		...
		It 'Should have the expected parameter WitRefName' {
			$parameter = (Get-Command Remove-ADOWorkItemTypeRule).Parameters['WitRefName']
		...
		It 'Should have the expected parameter RuleId' {
			$parameter = (Get-Command Remove-ADOWorkItemTypeRule).Parameters['RuleId']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Remove-ADOWorkItemTypeRule).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Remove-ADOWorkItemTypeRule).Parameters['ProgressAction']
