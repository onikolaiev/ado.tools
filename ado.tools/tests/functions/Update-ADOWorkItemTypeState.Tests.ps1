Describe "Update-ADOWorkItemTypeState Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Update-ADOWorkItemTypeState).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Update-ADOWorkItemTypeState).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Update-ADOWorkItemTypeState).Parameters['Token']
		...
		It 'Should have the expected parameter ProcessId' {
			$parameter = (Get-Command Update-ADOWorkItemTypeState).Parameters['ProcessId']
		...
		It 'Should have the expected parameter WitRefName' {
			$parameter = (Get-Command Update-ADOWorkItemTypeState).Parameters['WitRefName']
		...
		It 'Should have the expected parameter StateId' {
			$parameter = (Get-Command Update-ADOWorkItemTypeState).Parameters['StateId']
		...
		It 'Should have the expected parameter Body' {
			$parameter = (Get-Command Update-ADOWorkItemTypeState).Parameters['Body']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Update-ADOWorkItemTypeState).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Update-ADOWorkItemTypeState).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Token -ProcessId -WitRefName -StateId -Body
		__AllParameterSets -Organization -Token -ProcessId -WitRefName -StateId -Body -ApiVersion -ProgressAction
		#>
	}
