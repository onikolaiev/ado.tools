Describe "Remove-ADOWorkItemTypeState Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Remove-ADOWorkItemTypeState).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Remove-ADOWorkItemTypeState).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Remove-ADOWorkItemTypeState).Parameters['Token']
		...
		It 'Should have the expected parameter ProcessId' {
			$parameter = (Get-Command Remove-ADOWorkItemTypeState).Parameters['ProcessId']
		...
		It 'Should have the expected parameter WitRefName' {
			$parameter = (Get-Command Remove-ADOWorkItemTypeState).Parameters['WitRefName']
		...
		It 'Should have the expected parameter StateId' {
			$parameter = (Get-Command Remove-ADOWorkItemTypeState).Parameters['StateId']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Remove-ADOWorkItemTypeState).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Remove-ADOWorkItemTypeState).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Token -ProcessId -WitRefName -StateId
		__AllParameterSets -Organization -Token -ProcessId -WitRefName -StateId -ApiVersion -ProgressAction
		#>
	}
