Describe "Get-ADOProcessBehaviorList Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-ADOProcessBehaviorList).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Get-ADOProcessBehaviorList).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Get-ADOProcessBehaviorList).Parameters['Token']
		...
		It 'Should have the expected parameter ProcessId' {
			$parameter = (Get-Command Get-ADOProcessBehaviorList).Parameters['ProcessId']
		...
		It 'Should have the expected parameter Expand' {
			$parameter = (Get-Command Get-ADOProcessBehaviorList).Parameters['Expand']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Get-ADOProcessBehaviorList).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-ADOProcessBehaviorList).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Token -ProcessId
		__AllParameterSets -Organization -Token -ProcessId -Expand -ApiVersion -ProgressAction
		#>
	}
