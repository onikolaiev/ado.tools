Describe "Add-ADOWorkItemTypeGroupControl Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Add-ADOWorkItemTypeGroupControl).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Add-ADOWorkItemTypeGroupControl).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Add-ADOWorkItemTypeGroupControl).Parameters['Token']
		...
		It 'Should have the expected parameter ProcessId' {
			$parameter = (Get-Command Add-ADOWorkItemTypeGroupControl).Parameters['ProcessId']
		...
		It 'Should have the expected parameter WitRefName' {
			$parameter = (Get-Command Add-ADOWorkItemTypeGroupControl).Parameters['WitRefName']
		...
		It 'Should have the expected parameter GroupId' {
			$parameter = (Get-Command Add-ADOWorkItemTypeGroupControl).Parameters['GroupId']
		...
		It 'Should have the expected parameter Body' {
			$parameter = (Get-Command Add-ADOWorkItemTypeGroupControl).Parameters['Body']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Add-ADOWorkItemTypeGroupControl).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Add-ADOWorkItemTypeGroupControl).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Token -ProcessId -WitRefName -GroupId -Body
		__AllParameterSets -Organization -Token -ProcessId -WitRefName -GroupId -Body -ApiVersion -ProgressAction
		#>
	}
