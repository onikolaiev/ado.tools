Describe "Add-ADOWorkItemTypeGroup Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Add-ADOWorkItemTypeGroup).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Add-ADOWorkItemTypeGroup).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Add-ADOWorkItemTypeGroup).Parameters['Token']
		...
		It 'Should have the expected parameter ProcessId' {
			$parameter = (Get-Command Add-ADOWorkItemTypeGroup).Parameters['ProcessId']
		...
		It 'Should have the expected parameter WitRefName' {
			$parameter = (Get-Command Add-ADOWorkItemTypeGroup).Parameters['WitRefName']
		...
		It 'Should have the expected parameter PageId' {
			$parameter = (Get-Command Add-ADOWorkItemTypeGroup).Parameters['PageId']
		...
		It 'Should have the expected parameter SectionId' {
			$parameter = (Get-Command Add-ADOWorkItemTypeGroup).Parameters['SectionId']
		...
		It 'Should have the expected parameter Body' {
			$parameter = (Get-Command Add-ADOWorkItemTypeGroup).Parameters['Body']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Add-ADOWorkItemTypeGroup).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Add-ADOWorkItemTypeGroup).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Token -ProcessId -WitRefName -PageId -SectionId -Body
		__AllParameterSets -Organization -Token -ProcessId -WitRefName -PageId -SectionId -Body -ApiVersion -ProgressAction
		#>
	}
