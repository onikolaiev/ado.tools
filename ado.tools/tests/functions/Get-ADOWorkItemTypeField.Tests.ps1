Describe "Get-ADOWorkItemTypeField Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-ADOWorkItemTypeField).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Get-ADOWorkItemTypeField).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Get-ADOWorkItemTypeField).Parameters['Token']
		...
		It 'Should have the expected parameter ProcessId' {
			$parameter = (Get-Command Get-ADOWorkItemTypeField).Parameters['ProcessId']
		...
		It 'Should have the expected parameter WitRefName' {
			$parameter = (Get-Command Get-ADOWorkItemTypeField).Parameters['WitRefName']
		...
		It 'Should have the expected parameter FieldRefName' {
			$parameter = (Get-Command Get-ADOWorkItemTypeField).Parameters['FieldRefName']
		...
		It 'Should have the expected parameter Expand' {
			$parameter = (Get-Command Get-ADOWorkItemTypeField).Parameters['Expand']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Get-ADOWorkItemTypeField).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-ADOWorkItemTypeField).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -Organization -Token -ProcessId -WitRefName -FieldRefName
		__AllParameterSets -Organization -Token -ProcessId -WitRefName -FieldRefName -Expand -ApiVersion -ProgressAction
		#>
	}
