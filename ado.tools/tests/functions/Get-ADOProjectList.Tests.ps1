Describe "Get-ADOProjectList Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Get-ADOProjectList).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Get-ADOProjectList).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Get-ADOProjectList).Parameters['Token']
		...
		It 'Should have the expected parameter StateFilter' {
			$parameter = (Get-Command Get-ADOProjectList).Parameters['StateFilter']
			$parameter.Name | Should -Be 'StateFilter'
			$parameter.ParameterType.ToString() | Should -Be ProjectState
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter Top' {
			$parameter = (Get-Command Get-ADOProjectList).Parameters['Top']
		...
		It 'Should have the expected parameter Skip' {
			$parameter = (Get-Command Get-ADOProjectList).Parameters['Skip']
		...
		It 'Should have the expected parameter ContinuationToken' {
			$parameter = (Get-Command Get-ADOProjectList).Parameters['ContinuationToken']
		...
		It 'Should have the expected parameter GetDefaultTeamImageUrl' {
			$parameter = (Get-Command Get-ADOProjectList).Parameters['GetDefaultTeamImageUrl']
			$parameter.Name | Should -Be 'GetDefaultTeamImageUrl'
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Get-ADOProjectList).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Get-ADOProjectList).Parameters['ProgressAction']
	...
	Describe "Testing parameterset __AllParameterSets" {
		...
		__AllParameterSets -Organization -Token -StateFilter -Top -Skip -ContinuationToken -GetDefaultTeamImageUrl -ApiVersion -ProgressAction
		#>
	}
