Describe "Remove-ADOWorkItemType Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Remove-ADOWorkItemType).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Organization' {
			$parameter = (Get-Command Remove-ADOWorkItemType).Parameters['Organization']
		...
		It 'Should have the expected parameter Token' {
			$parameter = (Get-Command Remove-ADOWorkItemType).Parameters['Token']
		...
		It 'Should have the expected parameter ProcessId' {
			$parameter = (Get-Command Remove-ADOWorkItemType).Parameters['ProcessId']
		...
		It 'Should have the expected parameter WitRefName' {
			$parameter = (Get-Command Remove-ADOWorkItemType).Parameters['WitRefName']
		...
		It 'Should have the expected parameter ApiVersion' {
			$parameter = (Get-Command Remove-ADOWorkItemType).Parameters['ApiVersion']
		...
		It 'Should have the expected parameter ProgressAction' {
			$parameter = (Get-Command Remove-ADOWorkItemType).Parameters['ProgressAction']
