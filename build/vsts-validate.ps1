...
$modules = @("PowerShellGet", "PSFramework", "PSScriptAnalyzer", "PSNotification", "dbatools", "ado.core")
...
& "$PSScriptRoot\..\ado.tools\tests\pester.ps1" -TestGeneral $TestGeneral -TestFunctions $TestFunctions -Exclude $Exclude